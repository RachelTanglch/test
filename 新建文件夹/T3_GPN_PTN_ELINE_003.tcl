...
if {[catch {
	...
	set lHStream "$hGPNPort3Stream1 $hGPNPort3Stream2 $hGPNPort2Stream3 $hGPNPort4Stream4\
					  $hGPNPort4Stream5 $hGPNPort4Stream6 $hGPNPort1Stream7"
	...
	if {[string match "L2" $trunkLevel]} {
		...
		gwd::GWTrunk_AddInfo $telnet1 $matchType1 $Gpn_type1 $fileId "t1" "" "$GPNPort5 $GPNPort7"
		gwd::GWL2Inter_AddVlanPort $telnet1 $matchType1 $Gpn_type1 $fileId "10" "trunk" "t1" "untagged"
		gwd::GWpublic_CfgVlanIp $telnet1 $matchType1 $Gpn_type1 $fileId "10" $ip1 "24"
		gwd::GWStaLsp_AddLspInfo $telnet1 $matchType1 $Gpn_type1 $fileId "lsp1" "vlan" "v10" $ip2 "100" "100" "normal" "1"
		
		gwd::GWL2_AddPort $telnet3 $matchType3 $Gpn_type3 $fileId $GPNPort6 "disable" "enable"
		gwd::GWL2_AddPort $telnet3 $matchType3 $Gpn_type3 $fileId $GPNPort8 "disable" "enable"
		gwd::GWTrunk_AddInfo $telnet3 $matchType3 $Gpn_type3 $fileId "t1" "" "$GPNPort6 $GPNPort8"
		gwd::GWL2Inter_AddVlanPort $telnet3 $matchType3 $Gpn_type3 $fileId 10 "trunk" "t1" "untagged"
		gwd::GWpublic_CfgVlanIp $telnet3 $matchType3 $Gpn_type3 $fileId "10" $ip2 "24"
		gwd::GWStaLsp_AddLspInfo $telnet3 $matchType3 $Gpn_type3 $fileId "lsp1" "vlan" "v10" $ip1 "100" "100" "normal" "2"
	} else {
		...
		gwd::GWL3Inter_AddL3 $telnet1 $matchType1 $Gpn_type1 $fileId "trunk" "t1" "10"
		gwd::GWL3port_AddIP $telnet1 $matchType1 $Gpn_type1 $fileId "trunk" "t1" "10" $ip1 "24"
		gwd::GWStaLsp_AddLspInfo $telnet1 $matchType1 $Gpn_type1 $fileId "lsp1" "trunk" "t1.10" $ip2 "100" "100" "normal" "1"
		
		gwd::GWL2_AddPort $telnet3 $matchType3 $Gpn_type3 $fileId $GPNPort6 "disable" "disable"
		gwd::GWL2_AddPort $telnet3 $matchType3 $Gpn_type3 $fileId $GPNPort8 "disable" "disable"
		gwd::GWTrunk_AddInfo $telnet3 $matchType3 $Gpn_type3 $fileId "t1" "" "$GPNPort6 $GPNPort8"
		gwd::GWL3_AddInterDcn $telnet3 $matchType3 $Gpn_type3 $fileId "trunk" "t1" "enable"
		gwd::GWL3Inter_AddL3 $telnet3 $matchType3 $Gpn_type3 $fileId "trunk" "t1" "10"
		gwd::GWL3port_AddIP $telnet3 $matchType3 $Gpn_type3 $fileId "trunk" "t1" "10" $ip2 "24"
		gwd::GWStaLsp_AddLspInfo $telnet3 $matchType3 $Gpn_type3 $fileId "lsp1" "trunk" "t1.10" $ip1 "100" "100" "normal" "2"
	}
	...
	gwd::GWpublic_CfgLspAddress $telnet3 $matchType3 $Gpn_type3 $fileId "lsp1" $address2
	...
	##------得到trunk组成员的主端口和从端口，端口号小的口是主端口
	            #####################################################lag模式为1:1##################################################################
	if {[Test_TrunkMode $telnet3 $matchType3 $Gpn_type3 $fileId lag1:1 "t1" "$GPNPort6 $GPNPort8" $masterPort1 "GPN_PTN_003"]} {
		set flag1_case1 1
	}
	puts $fileId ""
	if {$flag1_case1 == 1} {
	...
	gwd::GWpublic_addTrunkMode $telnet3 $matchType3 $Gpn_type3 $fileId "t1" "" "lag1+1"
	gwd::GWpublic_addTrunkMode $telnet1 $matchType1 $Gpn_type1 $fileId "t1" "" "lag1+1"
	if {[Test_TrunkMode $telnet1 $matchType1 $Gpn_type1 $fileId lag1+1 "t1" "$GPNPort5 $GPNPort7" $masterPort2 "GPN_PTN_003"]} {
		set flag2_case1 1
	}
	puts $fileId ""
	if {$flag2_case1 == 1} {
	...
	gwd::GWpublic_addTrunkPolicy $telnet1 $matchType1 $Gpn_type1 $fileId "t1" "" "dstmac-based"
	gwd::GWpublic_addTrunkMode $telnet3 $matchType3 $Gpn_type3 $fileId "t1" "" "sharing"
	gwd::GWpublic_addTrunkPolicy $telnet3 $matchType3 $Gpn_type3 $fileId "t1" "" "dstmac-based"
	if {[Test_TrunkMode $telnet3 $matchType3 $Gpn_type3 $fileId sharing "t1" "$GPNPort6 $GPNPort8" $masterPort1 "GPN_PTN_003"]} {
		set flag3_case1 1
	}
	puts $fileId ""
	if {$flag3_case1 == 1} {
	...
	set slot1 0
	set slot2 0
	regexp {(\d+)/(\d+)} $GPNPort6 match slot1 port1
	regexp {(\d+)/(\d+)} $GPNPort10 match slot2 port2
	...
	set slot1 0
	set slot2 0
	regexp {(\d+)/(\d+)} $GPNPort5 match slot1 port1
	regexp {(\d+)/(\d+)} $GPNPort9 match slot2 port2
	if {$slot1 < $slot2} {
		set masterPort2 $GPNPort5
	} else {
	...
	if {[Test_TrunkMode $telnet1 $matchType1 $Gpn_type1 $fileId sharing "t1" "$GPNPort5 $GPNPort9" $masterPort2 "GPN_PTN_003"]} {
		set flag8_case1 1
	}
	puts $fileId ""
	if {$flag8_case1 == 1} {
	...
	gwd::GWpublic_addTrunkMode $telnet1 $matchType1 $Gpn_type1 $fileId "t1" "" "lag1+1"
	gwd::GWpublic_addTrunkMode $telnet3 $matchType3 $Gpn_type3 $fileId "t1" "" "lag1+1"
	if {[Test_TrunkMode $telnet3 $matchType3 $Gpn_type3 $fileId "lag1+1" "t1" "$GPNPort6 $GPNPort10" $masterPort1 "GPN_PTN_003"]} {
		set flag9_case1 1
	}
	puts $fileId ""
	if {$flag9_case1 == 1} {
	...
	gwd::GWpublic_addTrunkMode $telnet3 $matchType3 $Gpn_type3 $fileId "t1" "" "lag1:1"
	gwd::GWpublic_addTrunkMode $telnet1 $matchType1 $Gpn_type1 $fileId "t1" "" "lag1:1"
	if {[Test_TrunkMode $telnet1 $matchType1 $Gpn_type1 $fileId "lag1:1" "t1" "$GPNPort5 $GPNPort9" $masterPort2 "GPN_PTN_003"]} {
		set flag10_case1 1
	}
	puts $fileId ""
	if {$flag10_case1 == 1} {
		set flagCase1 1
		gwd::GWpublic_print "NOK" "FB1（结论）trunk模式为lag1:1、trunk组成员跨板卡，测试E-LINE与trunk互操作" $fileId
	} else {
		gwd::GWpublic_print "OK" "FB1（结论）trunk模式为lag1:1、trunk组成员跨板卡，测试E-LINE与trunk互操作" $fileId
	}
	puts $fileId ""
	gwd::GWpublic_sendSameStrToFiles "$fd_debug $fd_log $fileId" "=====trunk模式为lag1:1、trunk组成员跨板卡，测试E-LINE与trunk互操作  测试结束=====\n"
	incr tcId
	...
	if {$flag11_case1 == 1} {
		set flagCase1 1
		gwd::GWpublic_print "NOK" "FB2（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡添加down端口$downPort_dev1\
				$matchType3 t1成员$GPNPort6,$GPNPort10\在跨板卡添加down端口$downPort_dev3\测试业务" $fileId
	} else {
		gwd::GWpublic_print "OK" "FB2（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡添加down端口$downPort_dev1\
				$matchType3 t1成员$GPNPort6,$GPNPort10\在跨板卡添加down端口$downPort_dev3\测试业务" $fileId
	}
	puts $fileId ""
	gwd::GWpublic_sendSameStrToFiles "$fd_debug $fd_log $fileId" "=====trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡添加down端口$downPort_dev1\
	...
	if {$flag12_case1 == 1} {
		set flagCase1 1
		gwd::GWpublic_print "NOK" "FB3（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡删除down端口$downPort_dev1\
				$matchType3 t1成员$GPNPort6,$GPNPort10\在跨板卡删除down端口$downPort_dev3\测试业务" $fileId
	} else {
		gwd::GWpublic_print "OK" "FB3（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡删除down端口$downPort_dev1\
				$matchType3 t1成员$GPNPort6,$GPNPort10\在跨板卡删除down端口$downPort_dev3\测试业务" $fileId
	}
	puts $fileId ""
	gwd::GWpublic_sendSameStrToFiles "$fd_debug $fd_log $fileId" "=====trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡删除down端口$downPort_dev1\
	...
	if {$flag13_case1 == 1} {
		set flagCase1 1
		gwd::GWpublic_print "NOK" "FB4（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡添加up端口$GPNPort7\
				$matchType3 t1成员$GPNPort6,$GPNPort10\在跨板卡添加up端口$GPNPort8\测试业务" $fileId
	} else {
		gwd::GWpublic_print "OK" "FB4（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡添加up端口$GPNPort7\
				$matchType3 t1成员$GPNPort6,$GPNPort10\在跨板卡添加up端口$GPNPort8\测试业务" $fileId
	}
	puts $fileId ""
	gwd::GWpublic_sendSameStrToFiles "$fd_debug $fd_log $fileId" "=====trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡添加up端口$GPNPort7\
	...
	if {$flag14_case1 == 1} {
		set flagCase1 1
		gwd::GWpublic_print "NOK" "FB5（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡删除up端口$GPNPort7\
				$matchType3 t1成员$GPNPort6,$GPNPort10\在跨板卡删除up端口$GPNPort8\测试业务" $fileId
	} else {
		gwd::GWpublic_print "OK" "FB5（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡删除up端口$GPNPort7\
				$matchType3 t1成员$GPNPort6,$GPNPort10\在跨板卡删除up端口$GPNPort8\测试业务" $fileId
	}
	puts $fileId ""
	gwd::GWpublic_sendSameStrToFiles "$fd_debug $fd_log $fileId" "=====trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡删除up端口$GPNPort7\
	...
	if {[string match "L2" $trunkLevel]} {
		gwd::GWpublic_Delvlan $telnet1 $matchType1 $Gpn_type1 $fileId "10"
		gwd::GWpublic_Delvlan $telnet3 $matchType3 $Gpn_type3 $fileId "10"
		if {[string match "L3" $Worklevel]} {
			gwd::GWL3Inter_DelL3 $telnet1 $matchType1 $Gpn_type1 $fileId "ethernet" $GPNTestEth3 "50"
			gwd::GWL2_AddPort $telnet1 $matchType1 $Gpn_type1 $fileId $GPNTestEth2 "disable" "enable"
			gwd::GWL2_AddPort $telnet1 $matchType1 $Gpn_type1 $fileId $GPNTestEth3 "disable" "enable"
		}
		gwd::GWTrunk_AddInfo $telnet1 $matchType1 $Gpn_type1 $fileId "t2" "" "$GPNTestEth2,$GPNTestEth3"
		gwd::GWL2Inter_AddVlanPort $telnet1 $matchType1 $Gpn_type1 $fileId "50" "trunk" "t2" "tagged"
	} else {
		gwd::GWL3Inter_DelL3 $telnet1 $matchType1 $Gpn_type1 $fileId "trunk" "t1" "10"
		gwd::GWL3Inter_DelL3 $telnet1 $matchType1 $Gpn_type1 $fileId "trunk" "t1" "4094"
		gwd::GWL3Inter_DelL3 $telnet3 $matchType3 $Gpn_type3 $fileId "trunk" "t1" "10"
		gwd::GWL3Inter_DelL3 $telnet3 $matchType3 $Gpn_type3 $fileId "trunk" "t1" "4094"
		gwd::GWL3Inter_DelL3 $telnet1 $matchType1 $Gpn_type1 $fileId "ethernet" $GPNTestEth3 "50"
		gwd::GWL2_AddPort $telnet1 $matchType1 $Gpn_type1 $fileId $GPNTestEth2 "disable" "disable"
		gwd::GWL2_AddPort $telnet1 $matchType1 $Gpn_type1 $fileId $GPNTestEth3 "disable" "disable"
		gwd::GWTrunk_AddInfo $telnet1 $matchType1 $Gpn_type1 $fileId "t2" "" "$GPNTestEth2,$GPNTestEth3"
		gwd::GWL3_AddInterDcn $telnet1 $matchType1 $Gpn_type1 $fileId "trunk" "t2" "enable"
		gwd::GWL3Inter_AddL3 $telnet1 $matchType1 $Gpn_type1 $fileId "trunk" "t2" "50"		
	}
	gwd::GWTrunk_DelInfo $telnet1 $matchType1 $Gpn_type1 $fileId "t1" ""
	gwd::GWTrunk_DelInfo $telnet3 $matchType3 $Gpn_type3 $fileId "t1" ""
	if {[string match "L3" $Worklevel]} {
		gwd::GWL2_AddPort $telnet1 $matchType1 $Gpn_type1 $fileId $GPNPort5 "enable" "disable"
		gwd::GWL2_AddPort $telnet1 $matchType1 $Gpn_type1 $fileId $GPNPort7 "enable" "disable"
		gwd::GWL2_AddPort $telnet1 $matchType1 $Gpn_type1 $fileId $GPNPort9 "enable" "disable"
		gwd::GWL2_AddPort $telnet3 $matchType3 $Gpn_type3 $fileId $GPNPort6 "enable" "disable"
		gwd::GWL2_AddPort $telnet3 $matchType3 $Gpn_type3 $fileId $GPNPort8 "enable" "disable"
		gwd::GWL2_AddPort $telnet3 $matchType3 $Gpn_type3 $fileId $GPNPort10 "enable" "disable"
	}
	PTN_NNI_AddInterIp $fileId $Worklevel $interface11 $ip1 $GPNPort5 $matchType1 $Gpn_type1 $telnet1
	PTN_NNI_AddInterIp $fileId $Worklevel $interface10 $ip2 $GPNPort6 $matchType3 $Gpn_type3 $telnet3
	gwd::GWpublic_CfgLspTunnel $telnet1 $matchType1 $Gpn_type1 $fileId "lsp1" $interface11 $ip2 "100" "100" "normal" "1"
	gwd::GWpublic_CfgLspAddress $telnet1 $matchType1 $Gpn_type1 $fileId "lsp1" $address1
	gwd::GWpublic_CfgUndoShutLsp $telnet1 $matchType1 $Gpn_type1 $fileId "lsp1"
	gwd::GWpublic_CfgPw $telnet1 $matchType1 $Gpn_type1 $fileId "pw1" "l2transport" "1" "" $address1 "1000" "1000" "1" "nochange" "" 1 0 "0x8100" "0x8100" ""
	gwd::GWpublic_CfgAc $telnet1 $matchType1 $Gpn_type1 $fileId "ac50" "" "trunk t2" 50 0 "nochange" 1 0 0 "0x8100"
	gwd::GWpublic_CfgAcBind $telnet1 $matchType1 $Gpn_type1 $fileId "ac50" "pw1" "eline"
	
	gwd::GWpublic_CfgLspTunnel $telnet3 $matchType3 $Gpn_type3 $fileId "lsp1" $interface10 $ip1 "100" "100" "normal" "2"
	gwd::GWpublic_CfgLspAddress $telnet3 $matchType3 $Gpn_type3 $fileId "lsp1" $address2
	gwd::GWpublic_CfgUndoShutLsp $telnet3 $matchType3 $Gpn_type3 $fileId "lsp1"
	gwd::GWpublic_CfgPw $telnet3 $matchType3 $Gpn_type3 $fileId "pw1" "l2transport" "2" "" $address2 "1000" "1000" "2" "nochange" "" 1 0 "0x8100" "0x8100" ""
	gwd::GWpublic_CfgAc $telnet3 $matchType3 $Gpn_type3 $fileId "ac1" "" $GPNTestEth4 0 0 "nochange" 1 0 0 "0x8100"
	...
	set trunkRate [expr $aGPNPort3Cnt1(cnt6) + $aGPNPort2Cnt1(cnt6)]
	...
	if {$flag15_case1 == 1} {
		set flagCase1 1
		gwd::GWpublic_print "NOK" "FB6（结论）trunk模式为sharing，AC口为trunk口测试E-LINE业务" $fileId
	} else {
		gwd::GWpublic_print "OK" "FB6（结论）trunk模式为sharing，AC口为trunk口测试E-LINE业务" $fileId
	}
	puts $fileId ""
	gwd::GWpublic_sendSameStrToFiles "$fd_debug $fd_log $fileId" "=====trunk模式为sharing，AC口为trunk口测试E-LINE业务  测试结束=====\n"
	incr tcId
	gwd::GWpublic_saveTCCfg 1 $fileId "GPN_PTN_003_$tcId.xml" [pwd]/Untitled
	incr cfgId
	lappend FLAGF [gwd::GWpublic_uploadDevCfg 1 $lSpawn_id $lMatchType $lDutType $fileId $fd_log $startSeconds $lIp $ftp $cfgId "GPN_PTN_003" lFailFileTmp]
	...
	puts $fileId ""
        ...
        gwd::GWpublic_print "== FB1 == [expr {($flag10_case1 == 1) ? "NOK" : "OK"}]" "（结论）trunk模式为lag1:1、trunk组成员跨板卡，测试E-LINE与trunk互操作" $fileId
        gwd::GWpublic_print "== FB2 == [expr {($flag11_case1 == 1) ? "NOK" : "OK"}]" "（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡添加\
        				down端口$downPort_dev1 $matchType3 t1成员$GPNPort6,$GPNPort10\在跨板卡添加down端口$downPort_dev3\测试业务" $fileId
        gwd::GWpublic_print "== FB3 == [expr {($flag12_case1 == 1) ? "NOK" : "OK"}]" "（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡删除\
        				down端口$downPort_dev1 $matchType3 t1成员$GPNPort6,$GPNPort10\在跨板卡删除down端口$downPort_dev3\测试业务" $fileId
        gwd::GWpublic_print "== FB4 == [expr {($flag13_case1 == 1) ? "NOK" : "OK"}]" "（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡添加\
        				up端口$GPNPort7 $matchType3 t1成员$GPNPort6,$GPNPort10\在跨板卡添加up端口$GPNPort8\测试业务" $fileId
        gwd::GWpublic_print "== FB5 == [expr {($flag14_case1 == 1) ? "NOK" : "OK"}]" "（结论）trunk模式为sharing，$matchType1 t1成员$GPNPort5,$GPNPort9\在跨板卡删除\
